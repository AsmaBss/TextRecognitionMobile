...
export default function Sonede() {
  ...
  const [numHeight, setnumHeight] = useState('350'); //350 //----350
  const [numWidth, setnumWidth] = useState('750'); //1323  //----750
  const [numX, setnumX] = useState('3200'); //6187 //----3200
  const [numY, setnumY] = useState('400'); //1147 //----400
  ...
  const croppedNum = t => {
    ImageEditor.cropImage(t.path, {
      ...
      console.log('number detected === ', result[1]);
      setTextNum(result[1]);
    });
  };
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={{margin: 20}}>Numéro de la facture :</Text>
              ...
              <Text style={{margin: 20}}>Montant à payer :</Text>
              <View style={{flexDirection: 'column', alignItems: 'center'}}>
                <View style={{flexDirection: 'row'}}>
                  <Text style={{marginTop: 5}}>Height : </Text>
                  <TextInput
              ...
              <Text style={{margin: 20}}>Date de la facture :</Text>
              <View style={{flexDirection: 'column', alignItems: 'center'}}>
                <View style={{flexDirection: 'row'}}>
                  <Text style={{marginTop: 5}}>Height : </Text>
                  <TextInput
